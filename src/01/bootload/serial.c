...
#define H8_3069F_SCI_SCR_RIE  (1<<6) /* 受信割込有効 */
#define H8_3069F_SCI_SCR_TIE  (1<<7) /* 送信割込有効 */
...
#define H8_3069F_SCI_SSR_RDRF   (1<<6) /* 受信有効 */
#define H8_3069F_SCI_SSR_TDRE   (1<<7) /* 送信有効 */
